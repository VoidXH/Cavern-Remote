...
namespace CavernRemoteCGI.Commands {
    public class VolumeControlCommand : Command {
        public override string Help => "volume=<up/done/mute>: Control Windows volume.";
        ...
        public override void Run(string param) {
            switch (param) {
                ...
                case "down":
                    ...
                    break;
                case "mute":
                    SendMessage(GetForegroundWindow(), WM_APPCOMMAND, IntPtr.Zero, (IntPtr)APPCOMMAND_VOLUME_MUTE);
                    break;
                default:
